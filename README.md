...
- [Learning Resources (Curriculum & PD)](#learning-resources-curriculum--pd)
- [Student Practice & Skill-Building](#student-practice--skill-building)
- [Creative & Productivity Tools](#creative--productivity-tools)
- [Ideas for Future Sections](#ideas-for-future-sections)

---

## How This Repo Is Organized

- **Purpose:** Central place to collect links, files, and lesson ideas for Digital Literacy.
- **Audience:** Me (and potentially other teachers) planning units, grabbing links for Canvas, or building activities quickly.
- **Sections below:**
  - **Learning Resources** – full curricula, professional learning, scope & sequence.
  - **Student Practice** – sites where students actually *do* the thing (typing, coding, projects).
  - **Creative & Productivity Tools** – apps we use in class for creating products.

As this grows, I can:
- Add **subfolders** (e.g., `unit_1_introduction_to_ai`, `unit_2_digital_citizenship`).
- Drop in **Google Doc / Slide templates**, exported PDFs, and assignment descriptions.

---

## Learning Resources (Curriculum & PD)
...
## Student Practice & Skill-Building

Links students can use directly for practice, projects, or extension work.
...
_This README is a starting point. I’ll keep adding resources, notes, and unit folders as I refine my Digital Literacy course._
